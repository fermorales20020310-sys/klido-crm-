...
await pool.query(`ALTER TABLE conversations ADD COLUMN IF NOT EXISTS last_time BIGINT`);
await pool.query(`ALTER TABLE conversations ADD COLUMN IF NOT EXISTS unread BOOLEAN DEFAULT true`);
await pool.query(`ALTER TABLE conversations ADD COLUMN IF NOT EXISTS unread_dot TEXT DEFAULT 'transparent'`);
await pool.query(`ALTER TABLE conversations ADD COLUMN IF NOT EXISTS last_type TEXT DEFAULT 'text'`);
await pool.query(`ALTER TABLE conversations ADD COLUMN IF NOT EXISTS tag TEXT DEFAULT 'nuevo'`);
await pool.query(`ALTER TABLE conversations ADD COLUMN IF NOT EXISTS updated_at BIGINT`);
